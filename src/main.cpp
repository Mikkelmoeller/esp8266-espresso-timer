...
long timerStart = 0;
long lastSlowAnimation = 0;
long lastFastAnimation = 0;
long doneSince = 0;
long doneTillStandby = 0;
...
const int minTimeBetweenInterrupts = 10000; // In microseconds
...
void loop() {
  ...
  if (remainingTimeBudget > 0) {
    ...
    delay(1); // 1 ms delay for reasons
  }
